...
\begin{figure}[H]
	...
	\caption[Sampled biological soil crust for the study sites]{Sampled biological soil crust for PA (a), SG (b), LC (c), and NA (d).}
...
\caption[Significant factors for response variables based on generalized linear models]{Appendix A. Significant factors for response variables based on generalized linear models. Models with significant interaction also include the predictors as simple parameters based on marginality principle. \\ % Line break in caption
