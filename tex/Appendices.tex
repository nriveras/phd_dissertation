...
% --- Include the Manuscript Files as Chapters ---
% The \include command starts each file on a new page and uses the
% chapter numbering defined by \appendix (A, B, C...)
\input{tex/Manuscript-1}
\input{tex/Manuscript-2}
\input{tex/Manuscript-3}
\input{tex/Manuscript-4}
\input{tex/Manuscript-5}

% --- Add Bibliography, Index etc. if needed ---
