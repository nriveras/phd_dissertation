...
% --- Main Bibliography ---
% This bibliography will ONLY include citations made in the files
% included ABOVE this point (Introduction, Methodology, etc.)
\bibliographystyle{apalike}
\bibliography{literatur}

\appendix % Start the appendix environment (changes chapter numbering to A, B, ...)

% Adds "Appendix" to the Table of Contents
\addcontentsline{toc}{chapter}{Appendix}
% --- Appendices ---
% REMOVE the include for Appendices.tex
